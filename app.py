...
def main():
    ...
    max_length = st.number_input("Max Length", min_value=10, max_value=1000, step=10, value=100)
    min_length = st.number_input("Min Length", min_value=10, max_value=1000, step=10, value=10)
